...
// Definición de rutas de /quizes
  ...
  router.get('/quizes/new', sessionController.timeout, sessionController.loginRequired, multer({ dest: './public/media/'}), quizController.new);
  ...
  router.delete('/quizes/:quizId(\\d+)', sessionController.timeout, sessionController.loginRequired, quizController.ownershipRequired, multer({ dest: './public/media/'}), quizController.destroy);
